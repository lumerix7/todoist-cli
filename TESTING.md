...
| --- | --- | --- | --- | --- |
| ✅ | 2026-03-16 | help | `todoist-cli help` | Main help prints without error |
...
| ✅ | 2026-03-16 | auth | `todoist-cli whoami --markdown` | Markdown table prints for user info output |
...
| ✅ | 2026-03-16 | overview | `todoist-cli overview --compact` | Compact summary prints for overview output |
| ✅ | 2026-03-16 | projects | `todoist-cli projects` | Projects list prints |
| ✅ | 2026-03-16 | projects | `todoist-cli projects "CLI Test"` | Project search returns the test project |
...
| ✅ | 2026-03-16 | doctor | `todoist-cli doctor` | Reports config/token status, dependency versions, and API reachability |
...
| ✅ | 2026-03-16 | errors | `todoist-cli list --project "CLI Test" --compact --markdown` | Clean validation error requiring a single output mode |
